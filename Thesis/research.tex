...
\todo{Todo: create figure of this.} We also show the results of training the autoencoder itself. As mentioned, it is trained on $240.000$ observations, corresponding to $1000$ episodes. Unfortunately I can't access the full results of this at the moment since Colab kicked me out due to usage limit. I do have some truncated results. The autoencoder starts with a loss around $200$. After the full $240.000$ episodes, its loss is around $1.0$, which is already achieved after around $215.000$ observations. After $180.000$ episodes, its loss is around $2.0$. 
