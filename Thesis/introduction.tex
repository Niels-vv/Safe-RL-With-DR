...
The main research question: what is the effect of state-space dimensionality reduction on model-free value-based reinforcement learning, by using PCA, autoencoders or DeepMDPs ? %how do different state-space dimensionality reduction methods compare in their effect on reinforcement learning agents?
